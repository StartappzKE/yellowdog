...
import ke.co.buildbrand.mhub.fragments.PublicFragment;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new PublicFragment(), "Home");
        adapter.addFrag(new PublicFragment(), "Library");
        adapter.addFrag(new PublicFragment(), "Tags");
